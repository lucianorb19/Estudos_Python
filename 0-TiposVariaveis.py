...
print("{} contém apenas letras': {}".format(a,a.isalpha()))
print("{} é minúsculo: {}".format(a,a.islower()))
print("{} é numérico: {}".format(a,a.isnumeric()))
print("{} é maiúsculo: {}".format(a,a.isupper()))
print("{} contém apenas espaços:{}".format(a,a.isspace))
print("{} primeira letra maiúscula e demais minúsculas:{}".format(a,a.istitle))
print()